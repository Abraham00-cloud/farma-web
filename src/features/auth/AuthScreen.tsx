...
export const AuthScreen: React.FC<AuthScreenProps> = ({ onAuthSuccess, portalType }) => {
    ...
    return (
        <div className="min-h-screen bg-[#ECE6D6] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
            ...
            {/* Minimalist branding header (Hidden during password recovery for focused clarity) */}
            {!isForgotPassword && (
                <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-6">
                    <div className="inline-flex items-center gap-2 font-['Fraunces',serif] font-semibold text-[1.8rem] text-[#101B14] mb-1">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-lg">
                <div className="mx-4 sm:mx-0 bg-[#F5F1E6] py-8 px-6 shadow-2xl border border-[#101B14]/10 rounded-2xl sm:px-10">
                    ...
                    {isForgotPassword ? (
                        <form onSubmit={handleForgotPasswordSubmit} className="space-y-4">
                            <p className="text-xs text-[#101B14]/80 leading-relaxed bg-white/60 p-3 rounded-xl border border-[#101B14]/10">
                                {isManager
                        ...
                        <form onSubmit={handleLoginSubmit} className="space-y-4">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-1">
                                    <label className="block text-xs font-semibold uppercase tracking-wider text-[#101B14]/80">Password</label>
                                    <button
                                        type="button"
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className="w-full px-3.5 py-2.5 pr-10 rounded-xl bg-white border border-[#101B14]/20 text-[#101B14] text-sm placeholder-[#8FA091] focus:outline-none focus:ring-2 focus:ring-[#D9A63E]"
                                    />
                                    <button
                                        type="button"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="••••••••"
                                            className="w-full px-3 py-2 pr-10 rounded-lg bg-white border border-[#101B14]/20 text-[#101B14] text-sm placeholder-[#8FA091] focus:outline-none focus:ring-1 focus:ring-[#D9A63E]"
                                        />
                                        <button
                                            type="button"
