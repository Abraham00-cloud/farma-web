...
export function ResetPasswordScreen() {
    ...
    // If there's no token present in the URL query string, show a clear fallback UI
    if (!token) {
        return (
            <div className="min-h-screen bg-[#ECE6D6] flex flex-col justify-center items-center p-4">
                <div className="max-w-md w-full bg-[#F5F1E6] rounded-[6px] border border-[#101B14]/15 p-8 shadow-sm text-center">

                    {/* Header */}
                    <div className="flex items-center justify-center space-x-3 pb-6 mb-6 border-b border-[#101B14]/15">
                    ...
                    <h2 className="text-lg font-bold text-[#101B14] mb-2">Invalid or Missing Token</h2>
                    <p className="text-xs text-[#101B14]/70 mb-6">
                        This recovery link is missing its security token or has expired. Please request a fresh reset link from the portal login page.
                    </p>

                    <button
                        onClick={() => navigate('/auth/proprietor')}
                        className="w-full bg-[#D9A63E] hover:bg-[#c49332] text-[#101B14] font-bold text-xs uppercase tracking-wider py-3 px-4 rounded-[4px] transition"
                    >
    ...
    return (
        <div className="min-h-screen bg-[#ECE6D6] flex flex-col justify-center items-center p-4">
            <div className="max-w-md w-full bg-[#F5F1E6] rounded-[6px] border border-[#101B14]/15 p-8 shadow-sm">
                ...
                {message && (
                    <div
                        className={`p-3 rounded-[4px] text-xs font-medium mb-4 border ${message.type === 'success'
