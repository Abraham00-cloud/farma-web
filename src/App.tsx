    ...
    <div className="flex h-screen bg-[#F8FAFC] text-slate-800 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <main className="p-6 sm:p-8 flex-1 space-y-8">
          ...
          {activeTab === 'managers' && authData.organisationId && (
          ...
          {activeTab === 'sections' && authData.organisationId && (
            <div className="max-w-7xl mx-auto">
              <GlobalSectionsView organisationId={authData.organisationId} />
            </div>
          )}

          {activeTab === 'batches' && authData.organisationId && (
            <div className="max-w-7xl mx-auto">
              <BatchManagementView organisationId={authData.organisationId} />
            </div>
          )}

          {activeTab === 'daily-logs' && authData.organisationId && (
            <div className="max-w-7xl mx-auto">
              <DailyLogsHubView organisationId={authData.organisationId} />
            </div>
          )}

          {activeTab === 'inventory' && authData.organisationId && (
            <div className="max-w-7xl mx-auto">
              <InventoryManagementView organisationId={authData.organisationId} />
            </div>
          )}

          {activeTab === 'financials' && authData.organisationId && (
            <div className="max-w-7xl mx-auto">
              <FinancialWorkspaceView organisationId={authData.organisationId} />
            </div>
          )}

          {activeTab === 'analytics' && authData.organisationId && (
            <div className="max-w-7xl mx-auto">
              <AnalyticsCommandHubView organisationId={authData.organisationId} />
            </div>
          )}
        </main>
      </div>
